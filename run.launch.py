...
def generate_launch_description():
    ...
    pkg_path = os.path.join(get_package_share_directory('mb1'))
    ...
    # crea un lanzador para modbus_bridge
    launch_modbus_bridge= Node(
        package='mb1',
        executable='modbus_bridge',
        name='modbus_bridge',
    )
    # crea un lanzador para rutine_an4
    launch_rutine_an4= Node(
        package='mb1',
        executable='rutine_an4',
        name='rutine_an4',
    )
